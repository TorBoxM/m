...
pub fn inject_runtime_params(
    ...
    #[cfg(windows)]
    {
        ...
        let pipe_path = r"\\.\pipe\TorBox_dev".to_string();
        #[cfg(not(debug_assertions))]
        let pipe_path = r"\\.\pipe\TorBox".to_string();
    ...
    {
        #[cfg(debug_assertions)]
        let socket_path = "/tmp/TorBox_dev.sock".to_string();
        #[cfg(not(debug_assertions))]
        let socket_path = "/tmp/TorBox.sock".to_string();
